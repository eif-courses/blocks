...
const {users} = storeToRefs(store); // make authenticated state reactive
    ...
    <div class="surface-card shadow-2 border-round p-4">
      ...
      <ul class="list-none p-0 m-0" v-for="u in users" :key="u.id">
        <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
          <div class="flex">
            <img src="https://xsgames.co/randomusers/avatar.php?g=female" class="mr-3" style="width: 45px; height: 45px" />
